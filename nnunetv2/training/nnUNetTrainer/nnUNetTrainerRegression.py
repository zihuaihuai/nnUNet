...
from nnunetv2.training.nnunet_logging.nnunet_logger import nnUNetLogger
...
class nnUNetTrainerRegression(nnUNetTrainer):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict,
        ...
        self.loss = torch.nn.MSELoss  # -> self.initialize
